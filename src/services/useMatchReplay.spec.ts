...
describe('Match Replay Engine (useMatchReplay.ts)', () => {
  const initialPlayers: Player[] = [
    { name: 'Ali', isDead: false, role: { id: 'godfather', name: 'Godfather', sideId: 'mafia' } },
    { name: 'Sarah', isDead: false, role: { id: 'doctor', name: 'Doctor', sideId: 'town' } },
    { name: 'Reza', isDead: false, role: { id: 'detective', name: 'Detective', sideId: 'town' } },
    { name: 'Mona', isDead: false, role: { id: 'citizen', name: 'Citizen', sideId: 'town' } },
  ];
