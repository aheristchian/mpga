...
export const modeSvgMap: Record<string, string> = {
  godfather: `
 ...
 */
export const scenarioIconSvgMap: Record<string, string> = {
  godfather: `
 ...
 */
export const mpgaLogoSvg: string = `
 ...
 */
export function getModeIllustration(modeId?: string | null): string | null {
 ...
 */
export function getScenarioIcon(modeId?: string | null): string | null {
  if (!modeId) return null;
 ...
 */
export function getMpgaLogo(): string {
  return mpgaLogoSvg;
}
